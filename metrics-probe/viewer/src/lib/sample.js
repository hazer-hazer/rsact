// Dev-only fixture so `vite dev` / `vite preview` render something. Never used
// in the built dashboard — metrics-probe injects real data into #metrics-data.
// Exercises the tricky paths: a gap, an improvement, a regression, sparse
// benches and sizes.
